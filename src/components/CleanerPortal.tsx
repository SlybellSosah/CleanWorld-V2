          ...
          {!selectedJob ? (
                  ...
                  {bookings.filter(b => b.status !== "cancelled").map((booking) => (
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center border-t border-slate-800/60 pt-2.5 mt-1 text-[10px] font-mono text-slate-400 w-full">
                        ...
                        <span className="text-white font-bold">${booking.price.toFixed(0)}</span>
                      </div>
                    </button>
                  ))}
                </div>
            ...
            <div className="space-y-5 animate-fadeIn">
              ...
              <div className="bg-slate-900 border border-slate-850 rounded-2xl p-4 space-y-2">
                ...
                <h3 className="font-display font-black text-base text-white capitalize">{selectedJob.cleanType} Cleaning Service</h3>
