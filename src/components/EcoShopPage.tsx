          ...
          >
            {filteredProducts.map((prod) => {
              ...
              return (
                ...
                >
                  {/* Category badge */}
                  <div className="absolute top-3 left-3 z-10 bg-slate-950/80 backdrop-blur-md border border-slate-800 px-2.5 py-1 rounded-lg text-xs font-mono text-slate-400">
                    {prod.category}
                  </div>
                ...
                <div className="space-y-4">
                      ...
                      <div key={item.product.id} className="flex items-center justify-between text-xs bg-slate-900 border border-slate-800/50 p-2.5 rounded-xl">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <span className="block text-xs text-slate-400 font-mono">Qty: {item.quantity}</span>
                          </div>
                        </div>
                  ...
                  <div className="bg-slate-900 border border-slate-800 p-4 rounded-2xl space-y-3 text-left">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="bg-emerald-500/10 text-emerald-400 font-mono text-xs font-bold px-2 py-0.5 rounded border border-emerald-500/20">
                        SAVE UP TO 15%
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-1.5 text-center">
                      {[
                        ...
                        >
                          {freq.label}
                          {freq.discount > 0 && <span className="block text-xs opacity-90">-{freq.discount}%</span>}
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-1.5 text-xs text-slate-400 leading-normal text-left">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start pb-4 border-b border-slate-800">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <span className="bg-emerald-500/10 border border-emerald-500/20 px-2 py-0.5 rounded text-xs font-mono text-emerald-400 uppercase">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {selectedProduct.ingredients.map((ing, idx) => (
                          <span key={idx} className="bg-slate-950 px-2.5 py-1 rounded-md text-xs text-slate-400 border border-slate-850">
                            {ing}
                          </span>
                        ))}
                      </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {selectedProduct.hseCertifications.map((cert, idx) => (
                          <span key={idx} className="bg-emerald-950/20 text-emerald-400 border border-emerald-500/20 px-2.5 py-1 rounded text-xs font-mono">
                            {cert}
                          </span>
                        ))}
                      </div>
                  ...
                  {selectedProduct.ecoMetrics && (
                    <div className="space-y-2 bg-slate-950 p-4 rounded-2xl border border-slate-850">
                      <h4 className="font-display text-xs font-bold text-slate-400 uppercase tracking-wider">ENVIRONMENTAL IMPACT REPORT</h4>
                      <div className="grid grid-cols-2 gap-3 pt-2">
                        {selectedProduct.ecoMetrics.carbonSaved && (
                          <div className="space-y-0.5">
                            <span className="text-xs text-slate-400 font-mono">Carbon Reduction</span>
                        ...
                        {selectedProduct.ecoMetrics.waterSaved && (
                          <div className="space-y-0.5">
                            <span className="text-xs text-slate-400 font-mono">Water Preserved</span>
                        ...
                        {selectedProduct.ecoMetrics.biodegradable && (
                          <div className="space-y-0.5 col-span-2">
                            <span className="text-xs text-slate-400 font-mono">Biodegradable Duration</span>
                  ...
                  {selectedProduct.hazards && (
                    <div className="bg-red-500/10 border border-red-500/20 p-3 rounded-xl flex gap-3 text-red-400">
                      ...
                      <div>
                        ...
                        <p className="text-xs leading-relaxed text-red-300/90 mt-0.5">{selectedProduct.hazards}</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="pt-4 border-t border-slate-800 flex justify-between items-center">
                <p className="text-xs text-slate-400 font-mono">Formulated with biodegradable ingredients.</p>
            ...
            >
              ...
              {checkoutStep === 1 && (
                <div className="space-y-4 text-xs font-sans">
                  <div className="space-y-1">
                    <label className="text-xs text-slate-400 uppercase font-mono font-bold tracking-wider">Recipient Name</label>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-xs text-slate-400 uppercase font-mono font-bold tracking-wider">Juba District</label>
                      <div className="relative">
                    ...
                    <div className="space-y-1">
                      <label className="text-xs text-slate-400 uppercase font-mono font-bold tracking-wider">Mobile Number</label>
                      <div className="relative">
                  ...
                  <div className="space-y-1">
                    <label className="text-xs text-slate-400 uppercase font-mono font-bold tracking-wider">Delivery Street Address</label>
                    <textarea 
                  ...
                  <div className="pt-2 border-t border-slate-850 flex justify-between items-center text-xs">
                    <div>
                      <span className="text-xs text-slate-400 block">AMOUNT TO CHARGE:</span>
                    ...
                    {[
                      ...
                      return (
                        ...
                        >
                          ...
                          <div>
                            <span className="block text-xs text-slate-400 uppercase font-mono tracking-wider">CARRIER</span>
                            <span className="text-xs font-semibold text-slate-300 block">{carrier.desc}</span>
                          </div>
                        </button>
                      );
                    })}
                    ...
                    {!isProcessingPayment ? (
                      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-4 animate-fadeIn">
                        ...
                        <div className="flex justify-between items-center pb-2 border-b border-slate-850">
                          <span className="font-mono text-xs font-bold text-slate-400 uppercase tracking-widest">{paymentCarrier} USSD GATE</span>
                        ...
                        <div className="space-y-1 text-center py-2">
                          <p className="text-xs text-slate-400">Merchant: Clean World Inc.</p>
                          <p className="text-sm font-black text-white">{formatPrice(grandTotal)}</p>
                          <p className="text-xs text-slate-400 font-mono">Carrier Target: {phoneNum}</p>
                        </div>
                        ...
                        <button
                          ...
                          className="w-full bg-emerald-500 hover:bg-emerald-400 text-slate-955 font-mono font-bold text-xs py-2 rounded-lg transition-colors"
                        >
                          Confirm &amp; Authorize
                        </button>
                      </div>
                      ...
                      <div className="py-12 text-center space-y-4 animate-pulse">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-xs text-slate-400 font-mono">Carrier: {paymentCarrier} Gateway</p>
                        </div>
                      </div>
                    )}

                    <div className="h-8 w-8 border border-slate-800 rounded-full mx-auto flex items-center justify-center text-xs text-slate-400 font-mono">SSD</div>
                  </div>
              ...
              {checkoutStep === 4 && createdOrder && (
                <div className="space-y-6 text-xs font-sans">
                  ...
                  <div className="bg-slate-950 border border-slate-850 p-4 rounded-2xl space-y-3">
                    <div className="flex justify-between items-center pb-2 border-b border-slate-850">
                      <span className="font-mono text-xs text-slate-400 font-bold uppercase">ORDER CONFIRMATION</span>
                    ...
                    <div className="space-y-1">
                      <span className="text-xs text-slate-400 font-mono uppercase block">SHIPPING ADDR</span>
                    ...
                    <div className="flex justify-between items-center pt-2 border-t border-slate-850">
                      <div>
                        <span className="text-xs text-slate-400 font-mono uppercase block">PAYMENT CARRIER</span>
                        <span className="font-semibold text-white">{createdOrder.paymentMethod}</span>
                      </div>
                      <div className="text-right">
                        <span className="text-xs text-slate-400 font-mono uppercase block">TOTAL AMOUNT</span>
                  ...
                  <div className="bg-sky-500/10 border border-sky-500/20 p-3.5 rounded-xl flex gap-3 text-sky-400">
                    ...
                    <div>
                      ...
                      <p className="text-xs leading-relaxed text-sky-300/90 mt-0.5">
