...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 32.00,
    unit: "5-Liter Canister",
    description: "Organic liquid compost & soil nutrition concentrate. Restores nutrient balance, improves water retention, and promotes healthy root development.",
...
export const SERVICES_DETAILS: ServiceDetail[] = [
  ...
  },
  {
    ...
    bulletPoints: [
      ...
      "Soil & Erosion Control: Erosion-prevention landscaping grids utilizing native grasses and terracing",
      "Corporate & Diplomatic: Immaculate high-profile gardens and green belt designs for estate and embassy compounds"
    ],
